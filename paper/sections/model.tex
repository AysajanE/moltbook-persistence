...
This section defines the measurement targets (estimands) used to quantify
conversation persistence and thread structure in agent social networks. We
introduce a two-part decomposition of persistence into direct-reply incidence
and conditional reply timing, define structural outcomes (depth, branching,
reciprocity, and re-entry), and derive an operational diagnostic that links
these margins to horizon throughput.
...
observed margins, not a causal policy-effect estimator.
