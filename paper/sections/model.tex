...
propositions are deferred to supplementary material (\Cref{sec:model:formal-deferred}).
...
\subsection{Deferred Formal Model and Propositions}
...
(iii) formal propositions and proofs. These appear in supplementary material
(Sections S0--S1).

\refstepcounter{theorem}\label{prop:tradeoff}
\noindent\textbf{Deferred Proposition \thetheorem (influence--persistence trade-off).}
Formal statement and proof are in supplementary Section S1.1.

\refstepcounter{theorem}\label{prop:thread-size}
\noindent\textbf{Deferred Proposition \thetheorem (root-special expected thread size).}
Formal statement and proof are in supplementary Section S1.2.

\refstepcounter{theorem}\label{prop:periodicity}
\noindent\textbf{Deferred Proposition \thetheorem (periodic mean-intensity detectability).}
Formal statement and proof are in supplementary Section S1.3.
