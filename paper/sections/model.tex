...
availability modulation. The OR contribution of this section is a
...
\begin{remark}[OR-facing measurement contribution]
...
inside \(\alpha_i\). A stylized mapping from these design knobs to model
parameters is
\begin{align}
\alpha_i(u) &=
