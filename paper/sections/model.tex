...
rather than identified causal estimands. Periodicity predictions are tested with
power spectral density (PSD)/autocorrelation
diagnostics, whereas platform-lever comparative statics are interpreted as
mechanism-consistent hypotheses. Because per-account heartbeat events are not directly logged,
\(b(t)\) is latent and inferred from aggregate periodic signatures.
