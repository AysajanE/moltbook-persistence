...
Social/Casual the shortest (0.01 hr). A run-scoped Reddit baseline (1,772 submissions;
9,878 comments) provides contextual comparison: Reddit threads show mean depth 2.169,
first-reply half-life 2.61 hours, direct-reply incidence 36.20\%, and
$\Prob(D \ge 5)=11.32\%$. A coarse matched observational comparison (813 pairs) confirms
significant platform differences in depth, duration, and participation under limited
controls. Matched causal inference with stronger identification is future work.
