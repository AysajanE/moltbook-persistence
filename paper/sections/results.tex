...
We executed coarse exact matching on the Moltbook and Reddit datasets described
in \Cref{sec:methods:comparison}.
...
describing the overlap region rather than the full platform population.
...
significant. On matched-thread subsets, Moltbook reply-kernel half-life is
