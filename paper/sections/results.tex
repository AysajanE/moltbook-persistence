...
Moltbook conversation trees are shallow (\cref{fig:depth-distribution}): mean depth is 1.378
...
Overall, Moltbook threads are strongly star-shaped (mean depth 1.378, median
...
Although power at the 4-hour target frequency is elevated relative to local
background, AR(1)-based tests remain non-significant across 5/15/30-minute
binning choices.
