...
(95\% bootstrap CI: [1.372, 1.383]), median depth is 1, the proportion reaching depth 5+
...
\(\lambda(s)=\alpha e^{-\beta s}\), with additional excess concentration at very
small \(s\).
...
Mean maximum depth per thread is 2.169 (median 1), \(\Prob(D \ge 5)=11.32\%\),
...
depth 1, \(\hat{\mu}=0.154\)), with rare bidirectional dyads (0.998\%) and
...
significant. These matched differences are secondary contextual estimates on
overlap support, not platform-wide causal effects. On matched-thread subsets,
Moltbook reply-kernel half-life is
0.0628 hours (3.77 minutes; 95\% CI: [1.19, 7.06] minutes), versus 2.4448 hours
for Reddit (95\% CI: [2.1298, 2.7926]). For Reddit periodicity, the dominant
