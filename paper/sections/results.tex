...
summary. However, within-thread and repeated-author dependence limits
model-based precision for isolating the claim indicator
(\Cref{sec:results:decomposition}), so this readout is interpreted as strong
descriptive association rather than definitive causal attribution.
