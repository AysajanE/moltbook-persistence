...
limited, with mean 0.195 and median 0.167 (distribution deferred to the supplementary material).
...
thread, close to the observed mean of 6.43 comments per thread (\Cref{sec:data}).
