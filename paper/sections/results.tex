...
The headline pattern is stable: low direct-reply incidence with very fast
conditional timing, plus shallow, root-concentrated thread geometry and limited
reciprocity/re-entry. Coverage-gap sensitivities preserve the post-gap
decomposition readout, and one-parent-per-thread sensitivity lowers incidence
levels without changing the qualitative speed-vs-incidence interpretation.
