...
Matched cross-platform construction follows \Cref{sec:methods:comparison} and is executed in
\texttt{analysis/08\_cross\_platform\_matched\_analysis.py} with run ID
\texttt{run\_20260206-182842Z}. Using deterministic topic mapping, UTC posting-hour bins, and
