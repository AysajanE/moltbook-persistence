...
Supplementary Section S2.1 reports sensitivity checks (alternative keyword
trigger lists and exclusion rules) to verify that the Social/Casual versus
...
records are absent (Supplementary Section S6.4). This pattern is
...
estimators as for Moltbook (\Cref{sec:results:reddit-full-scale}). Ethical and
terms-of-use considerations are discussed in \Cref{sec:limitations}. Main-text
reporting is intentionally limited; baseline mechanics and matched-overlap
diagnostics are deferred to Supplementary Sections S3.3 and S4--S4.4.
