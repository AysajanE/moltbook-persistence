...
\Cref{sec:results:comparison} using promoted artifacts in
\texttt{paper/tables/cross\_platform\_matched\_*.csv} and
\texttt{paper/figures/cross\_platform\_matched\_*.png}.
