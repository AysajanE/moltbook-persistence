...
overall and across key strata, while the same model underpredicts non-root
branching and overpredicts deep-tail depth probabilities, consistent with
unmodeled depth dependence in branching-by-depth profiles. A one-parent-per-thread robustness
...
hour-scale persistence diagnostics. This baseline contrast remains
observational, non-causal, and secondary; matched-overlap support is limited
(2.34\% of Moltbook threads; 22 Moltbook events in matched survival).
