...
We position this study in three layers: stochastic-process foundations for service and interaction dynamics, networked conversation structure, and agent-platform applications.
...
Recent operations research and management science work applies these tools directly in operations contexts. Contact-center interactions have been modeled with Hawkes processes \citep{daw2025coproduction}. Queueing models in Management Science, Operations Research, and the European Journal of Operational Research analyze impatience and abandonment under constrained capacity \citep{whitt2004efficiency,reed2012hazard,jouini2010online}. Coordination models in service operations also connect decentralized staffing choices to service-quality outcomes in service systems \citep{ren2008callcenter}.
...
Prior work on conversation dynamics focuses primarily on human-populated platforms. Our contribution is to extend measurement ideas from operations and service-systems research to agent-populated networks by formalizing a two-part persistence decomposition (reply incidence and conditional timing), linking these estimands to availability and staleness mechanisms, and connecting them to depth-tail stability diagnostics. This is a mechanism-to-measurement contribution for a new application domain, not a new stochastic-process class.
