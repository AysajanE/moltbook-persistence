...
\subsection*{S0.3 Model extensions for future estimation}
\label{sec:model:extensions}
Richer extensions (hierarchical random effects, re-entry self-excitation, and
visibility-weighted parent assignment) are not used for identification in this
first-week snapshot; we list them as candidate directions for future estimation.
