...
\subsection*{Roadmap Table (Moved from Main Text)}

\begin{table}[h]
\centering
\caption{Hypothesis roadmap (moved from the main manuscript to meet the page limit): measurement targets, empirical readout location, and headline finding.}
...
\subsection*{S9. Deferred Main-Text Figure: Re-Entry Distribution}
...
\subsection*{S10. Deferred Main-Text Table: Descriptive Statistics}

\begin{table}[h]
\centering
\caption{Descriptive statistics for processed Moltbook threads (\(N=34{,}730\) threads with at least one comment; moved from the main manuscript).}
...
\subsection*{S11. Deferred Main-Text Table: Moltbook Archive Schema Summary}

\begin{table}[h]
\centering
\caption{Moltbook Observatory Archive structure in the curated first-week snapshot (moved from the main manuscript).}
