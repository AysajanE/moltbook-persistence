...
\section*{S1. Mathematical Framework and Proofs}
\label{sec:appendix}
...
\subsection*{S1.1 Full intensity and competing-risks parent selection}
...
\subsection*{S1.2 Propositions and Proofs}

\subsubsection*{S1.2.1 Influence--persistence trade-off}
\begin{proposition}
...
\subsubsection*{S1.2.2 Root-special expected thread size}
\begin{proposition}
...
\subsubsection*{S1.2.3 Periodic mean-intensity detectability}
\begin{proposition}
...
\subsubsection*{S1.2.4 Horizon-throughput decomposition and priority rule}
\begin{proposition}
