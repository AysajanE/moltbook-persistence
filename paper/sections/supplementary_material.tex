...
and supporting proofs, robustness and diagnostic analyses, cross-platform
matching mechanics, and reproducibility information that complement the main
manuscript.
...
\section*{S0. Mathematical Formalism and Supporting Proofs}
\label{sec:appendix}
...
\subsection*{S0.2 Formal statements and proofs}
...
\subsubsection*{S1.1 Proof of S0.2.1 (influence--persistence trade-off)}
...
\subsubsection*{S1.2 Proof of S0.2.2 (root-special expected thread size)}
...
\subsubsection*{S1.3 Proof of S0.2.3 (periodic mean-intensity detectability)}
...
\subsubsection*{S1.4 Proof of S0.2.4 (horizon-throughput decomposition and priority rule)}
