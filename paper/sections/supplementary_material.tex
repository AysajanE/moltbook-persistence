...
\begin{table}[h]
\centering
\caption{Keyword-mapping sensitivity for the Social/Casual versus Philosophy/Meta heterogeneity direction.}
...
\begin{table}[h]
\centering
\caption{Matched paired-effects diagnostics. Mean difference is Moltbook minus Reddit (M-R).}
...
\begin{table}[h]
\centering
\caption{Category-stratified uncertainty (thread-cluster bootstrap; 400 reps; 95\% CI).}
