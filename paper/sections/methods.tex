...
\(r\), Rayleigh \(Z\), Monte Carlo \(p\)-value, and the detectability target
\(\kappa^\star\) (80\%-power phase concentration amplitude at observed
sample size). Power spectral density (PSD) and first-order autoregressive
...
Baseline comparisons are descriptive, non-causal, and reported only as
secondary context in the main manuscript (with mechanics and diagnostics
