...
(binning, detrending, and bootstrap mechanics) are documented in supplementary
material.
...
Full definitions and provenance-backed outputs are reported in
...
(AR(1)) calibration checks, plus bin-width sensitivity, are retained in
...
Given cross-platform confounding (interface, ranking, moderation, and
participation incentives) and known Reddit curation losses, baseline
comparisons are descriptive, non-causal, and secondary.
Main text reports only high-level directional contrasts; baseline mechanics,
overlap diagnostics, and matched analyses are deferred to Supplementary
Sections S3.3 and S4--S4.4.
