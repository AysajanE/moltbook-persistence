...
PSD/AR(1) and bin-width diagnostics are retained as supplementary checks rather
than primary inferential tests in the main manuscript.
...
secondary context in the main manuscript.
