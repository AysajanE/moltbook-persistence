...
Our central research questions are how quickly conversational engagement decays
on Moltbook and whether this decay shows a characteristic $\sim$4-hour timescale;
...
we test four hypotheses. H1 posits short reply-kernel half-lives consistent with
architectural constraints and periodic structure near the hypothesized heartbeat
cadence ($\tau \approx 4$ hours). H2 posits shallower, more root-concentrated
Moltbook trees than human-platform baselines, with lower reciprocity and re-entry.
...
reply data. Second, we provide a mechanism-grounded explanation linking shallow
conversation structure to measurable temporal decay under architectural
constraints. Third, we identify design levers---including memory scaffolding,
thread summarization, and return-to-thread incentives---that could extend
