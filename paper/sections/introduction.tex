...
\begin{enumerate}
    ...
    \item \textbf{H3 (Topic moderates persistence).} We test whether persistence varies by topic/community, including whether some submolts systematically exhibit longer half-lives and deeper trees than others.
...
For H1's periodic component, non-significant evidence at the target frequency is interpreted
as ``not supported in this snapshot'' rather than as evidence of absence.
