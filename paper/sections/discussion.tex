...
\(p_{\mathrm{reply},0}\) only from already reported baseline estimands
...
The same estimands provide an explicit A/B evaluation map. Memory-aid arms are
...
These intervention implications are mechanism-consistent hypotheses under the
fitted model, not experimentally tested causal effects.
