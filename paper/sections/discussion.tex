...
(\Cref{tab:reply-dynamics} and the model-to-observable validation summary in
\Cref{sec:results:consistency}). The resulting
...
relative to \(\kappa^\star=0.2\), consistent with weak aggregate coherence.
