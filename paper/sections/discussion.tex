...
The contrast with Reddit remains an open empirical question in this manuscript version,
pending completion of the matched comparison corpus.
...
These Moltbook-only comparisons provide a direct first check on whether the horizon-limited
cascade framework is a parsimonious explanation for early Moltbook dynamics.
