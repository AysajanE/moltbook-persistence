...
The model-to-observable validation loop sharpens this interpretation: predicted
...
Dependence robustness reinforces this product implication: when restricting to
