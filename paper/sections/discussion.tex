...
kernel half-life diagnostic is 0.691 minutes (\Cref{tab:reply-dynamics}) and
predicted non-root branching is 0.104 (\Cref{tab:model-observable-validation}).
If \(\beta\) is reduced by 50\% (equivalently, the kernel half-life diagnostic
doubles to
